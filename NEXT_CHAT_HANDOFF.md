...
- Verification: JavaScript syntax checks passed; `npm test` passed 209/209; two-bot simulation ran through normal turns/challenges/modifiers without stalling; Android landscape lobby and representative card assets were visually verified.
- Release cache version: `hts-v130`.
